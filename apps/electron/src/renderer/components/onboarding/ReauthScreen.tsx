 ...
 *
 * Shown when the user has existing workspaces/config but the Perplexity token
    ...
    <div className="flex min-h-screen flex-col bg-foreground-2">
      ...
      <main className="flex flex-1 items-center justify-center p-8">
        <StepFormLayout
          ...
          description={
            <>
              Your Perplexity session has expired or is no longer valid.
              <br />
              Please log in again to continue using Perplexity.
              <br />
